...
[task_local]
#中信优享+
00 00 *\/1 * * *, tag=中信优享+, img-url=, enabled=true

================Loon==============
[Script]
cron "00 00 *\/1 * * *", script-path=, tag=中信优享+

===============Surge=================
中信优享+ = type=cron, cronexp="00 00 *\/1 * * *", wake-system=1, timeout=33600, script-path=

============小火箭=========
中信优享+ = type=cron, script-path=, cronexpr="00 00 *\/1 * * *", timeout=33600, enable=true
*/
